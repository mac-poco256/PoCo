...
// ============================================================================
@implementation PoCoEditDensityDrawLine02
...
{
    DPRINT((@"[PoCoEditDensityDrawLine02 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditDensityDrawLine02 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditDensityDrawLine02 drawPoint:]\n"));
