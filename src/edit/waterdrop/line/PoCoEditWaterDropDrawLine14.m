...
// ============================================================================
@implementation PoCoEditWaterDropDrawLine14
...
{
    DPRINT((@"[PoCoEditWaterDropDrawLine14 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditWaterDropDrawLine14 dealloc]\n"));
...
-(void)drawPoint:(PoCoPoint *)p
{
    ...
    DPRINT((@"[PoCoEditWaterDropDrawLine14 drawPoint:]\n"));
