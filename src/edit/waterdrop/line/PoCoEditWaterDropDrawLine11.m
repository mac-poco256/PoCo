...
// ============================================================================
@implementation PoCoEditWaterDropDrawLine11
...
{
    DPRINT((@"[PoCoEditWaterDropDrawLine11 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditWaterDropDrawLine11 dealloc]\n"));
...
-(void)drawPoint:(PoCoPoint *)p
{
    ...
    DPRINT((@"[PoCoEditWaterDropDrawLine11 drawPoint:]\n"));
