...
// ============================================================================
@implementation PoCoEditWaterDropDrawLine08
...
{
    DPRINT((@"[PoCoEditWaterDropDrawLine08 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditWaterDropDrawLine08 dealloc]\n"));
...
-(void)drawPoint:(PoCoPoint *)p
{
    ...
    DPRINT((@"[PoCoEditWaterDropDrawLine08 drawPoint:]\n"));
