...
// ============================================================================
@implementation PoCoEditWaterDropDrawLine05
...
{
    DPRINT((@"[PoCoEditWaterDropDrawLine05 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditWaterDropDrawLine05 dealloc]\n"));
...
-(void)drawPoint:(PoCoPoint *)p
{
    ...
    DPRINT((@"[PoCoEditWaterDropDrawLine05 drawPoint:]\n"));
