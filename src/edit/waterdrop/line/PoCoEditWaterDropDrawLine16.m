...
// ============================================================================
@implementation PoCoEditWaterDropDrawLine16
...
{
    DPRINT((@"[PoCoEditWaterDropDrawLine16 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditWaterDropDrawLine16 dealloc]\n"));
...
-(void)drawPoint:(PoCoPoint *)p
{
    ...
    DPRINT((@"[PoCoEditWaterDropDrawLine16 drawPoint:]\n"));
