...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine12
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine12 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine12 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine12 drawPoint:]\n"));
