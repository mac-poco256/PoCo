...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine09
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine09 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine09 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine09 drawPoint:]\n"));
