...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine08
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine08 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine08 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine08 drawPoint:]\n"));
