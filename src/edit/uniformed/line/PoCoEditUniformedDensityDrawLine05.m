...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine05
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine05 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine05 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine05 drawPoint:]\n"));

    bbmp -= ((brow << 1) + 1); pbmp -= ((prow << 1) + 1);
    [dp moveX:-1 moveY:-2];
