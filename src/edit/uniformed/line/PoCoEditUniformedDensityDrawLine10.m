...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine10
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine10 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine10 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine10 drawPoint:]\n"));
