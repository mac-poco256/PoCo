...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine04
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine04 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine04 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine04 drawPoint:]\n"));
