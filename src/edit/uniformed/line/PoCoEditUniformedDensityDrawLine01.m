...
// ============================================================================
@implementation PoCoEditUniformedDensityDrawLine01
...
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine01 init]\n"));
...
-(void)dealloc
{
    DPRINT((@"[PoCoEditUniformedDensityDrawLine01 dealloc]\n"));
      ...
      patternRow:(const int)prow
{
    ...
    DPRINT((@"[PoCoEditUniformedDensityDrawLine01 drawPoint:]\n"));
