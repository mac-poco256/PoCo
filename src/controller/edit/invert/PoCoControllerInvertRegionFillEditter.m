...
// ============================================================================
@implementation PoCoControllerInvertRegionFillEditter
...
-(id)init:(PoCoPicture *)pict
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerInvertRegionFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerInvertRegionFillEditter dealloc]\n"));
...
-(BOOL)execute
{
    PoCoEditInvertRegionFill *edit;

    // 描画実行
    edit = [[PoCoEditInvertRegionFill alloc] initWithBitmap:[self->layer_ bitmap]
