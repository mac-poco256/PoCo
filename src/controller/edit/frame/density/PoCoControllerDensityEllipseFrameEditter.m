...
// ============================================================================
@implementation PoCoControllerDensityEllipseFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerDensityEllipseFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerDensityEllipseFrameEditter dealloc]\n"));
