...
// ============================================================================
@implementation PoCoControllerDensityCurveWithPointsEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   points:(NSMutableArray *)points
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerDensityCurveWithPointsEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerDensityCurveWithPointsEditter dealloc]\n"));
