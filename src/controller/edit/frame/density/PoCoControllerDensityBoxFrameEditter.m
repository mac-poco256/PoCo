...
// ============================================================================
@implementation PoCoControllerDensityBoxFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerDensityBoxFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerDensityBoxFrameEditter dealloc]\n"));
