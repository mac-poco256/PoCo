...
// ============================================================================
@implementation PoCoControllerNormalCurveWithPointsEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   points:(NSMutableArray *)points
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerNormalCurveWithPointsEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerNormalCurveWithPointsEditter dealloc]\n"));
