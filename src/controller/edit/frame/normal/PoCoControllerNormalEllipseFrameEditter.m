...
// ============================================================================
@implementation PoCoControllerNormalEllipseFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerNormalEllipseFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerNormalEllipseFrameEditter dealloc]\n"));
...
-(BOOL)execute
{
    ...
    // 編集開始
    if ([super startEdit:PEN_STYLE_SIZE
            withUndoCorr:PEN_STYLE_SIZE]) {
        // 編集系を生成
