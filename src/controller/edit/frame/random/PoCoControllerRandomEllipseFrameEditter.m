...
// ============================================================================
@implementation PoCoControllerRandomEllipseFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerRandomEllipseFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerRandomEllipseFrameEditter dealloc]\n"));
