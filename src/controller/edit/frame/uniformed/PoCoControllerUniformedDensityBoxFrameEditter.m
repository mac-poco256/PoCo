...
// ============================================================================
@implementation PoCoControllerUniformedDensityBoxFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerUniformedDensityBoxFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerUniformedDensityBoxFrameEditter dealloc]\n"));
