...
// ============================================================================
@implementation PoCoControllerUniformedDensityParallelogramFrameEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   second:(PoCoPoint *)s
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerUniformedDensityParallelogramFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerUniformedDensityParallelogramFrameEditter dealloc]\n"));
