...
// ============================================================================
@implementation PoCoControllerUniformedDensityEllipseFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerUniformedDensityEllipseFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerUniformedDensityEllipseFrameEditter dealloc]\n"));
