...
// ============================================================================
@implementation PoCoControllerWaterDropBoxFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerWaterDropBoxFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerWaterDropBoxFrameEditter dealloc]\n"));
