...
// ============================================================================
@implementation PoCoControllerAtomizerEllipseFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerAtomizerEllipseFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerAtomizerEllipseFrameEditter dealloc]\n"));
