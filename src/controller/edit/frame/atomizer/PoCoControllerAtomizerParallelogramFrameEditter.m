...
// ============================================================================
@implementation PoCoControllerAtomizerParallelogramFrameEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   second:(PoCoPoint *)s
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerAtomizerParallelogramFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerAtomizerParallelogramFrameEditter dealloc]\n"));
