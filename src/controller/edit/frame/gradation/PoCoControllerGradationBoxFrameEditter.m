...
// ============================================================================
@implementation PoCoControllerGradationBoxFrameEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerGradationBoxFrameEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerGradationBoxFrameEditter dealloc]\n"));
