...
// ============================================================================
@implementation PoCoControllerUniformedDensityParallelogramFillEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   second:(PoCoPoint *)s
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerUniformedDensityParallelogramFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerUniformedDensityParallelogramFillEditter dealloc]\n"));
