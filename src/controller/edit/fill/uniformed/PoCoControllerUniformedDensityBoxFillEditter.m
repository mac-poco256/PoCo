...
// ============================================================================
@implementation PoCoControllerUniformedDensityBoxFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerUniformedDensityBoxFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerUniformedDensityBoxFillEditter dealloc]\n"));
