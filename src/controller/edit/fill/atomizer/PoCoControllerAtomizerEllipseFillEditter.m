...
// ============================================================================
@implementation PoCoControllerAtomizerEllipseFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerAtomizerEllipseFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerAtomizerEllipseFillEditter dealloc]\n"));
