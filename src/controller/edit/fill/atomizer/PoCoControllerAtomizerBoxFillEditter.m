...
// ============================================================================
@implementation PoCoControllerAtomizerBoxFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerAtomizerBoxFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerAtomizerBoxFillEditter dealloc]\n"));
