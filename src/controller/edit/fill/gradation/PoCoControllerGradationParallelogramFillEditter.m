...
// ============================================================================
@implementation PoCoControllerGradationParallelogramFillEditter
...
-(id)init:(PoCoPicture *)pict
   ...
   second:(PoCoPoint *)s
    ...
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerGradationParallelogramFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerGradationParallelogramFillEditter dealloc]\n"));
