...
// ============================================================================
@implementation PoCoControllerGradationEllipseFillEditter
...
//  Return
//    function     : 実体
//    startPos_    : 描画始点(中点)(instance 変数)
//    endPos_      : 描画終点(中点)(instance 変数)
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerGradationEllipseFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerGradationEllipseFillEditter dealloc]\n"));
