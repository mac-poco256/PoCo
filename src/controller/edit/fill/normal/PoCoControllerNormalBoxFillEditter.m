...
// ============================================================================
@implementation PoCoControllerNormalBoxFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerNormalBoxFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerNormalBoxFillEditter dealloc]\n"));
