...
// ============================================================================
@implementation PoCoControllerWaterDropEllipseFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerWaterDropEllipseFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerWaterDropEllipseFillEditter dealloc]\n"));
