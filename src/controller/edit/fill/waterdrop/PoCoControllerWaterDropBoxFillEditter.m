...
// ============================================================================
@implementation PoCoControllerWaterDropBoxFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerWaterDropBoxFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerWaterDropBoxFillEditter dealloc]\n"));
