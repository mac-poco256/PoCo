...
// ============================================================================
@implementation PoCoControllerDensityEllipseFillEditter
...
orientation:(PoCoPoint *)o
    index:(int)idx
{
//    DPRINT((@"[PoCoControllerDensityEllipseFillEditter init]\n"));
...
-(void)dealloc
{
//    DPRINT((@"[PoCoControllerDensityEllipseFillEditter dealloc]\n"));
